...
//......prototypes start
void displayintroHeader();
void displaymainHeader();
void displayAdminmenu();
bool checkAdminpasword();
void viewBookings();
...
{ // main function implementation
    ...
    while (true)
    {
        ...
        else
        {
            ...
            cout << " please enter the corect option " << endl;
            getch();
        }
...
bool checkAdminpasword()
{
    ...
    for (int i = 0; i < 3; i++) // pasword checking
    {
        system("cls");
        cout << "\n"
...
void addBus()
{
    ...
    if (totalbuses < maxbuses)
    {
        ...
        if (alreadyExist)
        {
            cout << " This routealready exist !" << endl;
            cout << " You can only edit this route " << endl;
        }
        else
        {
            routes_name[totalbuses] = newroute;
...
void viewBuses()
{
    ...
    {
        cout << "=========== ALL BUSES ===========" << endl;
        cout << "No\tRoute\t\tFare\tTotalseats \tBooked seats\t Available" << endl;
        cout << "-------------------------------------------------------------" << endl;
